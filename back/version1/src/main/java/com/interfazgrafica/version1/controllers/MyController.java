...
public class MyController {
    ...
    public String testSaveData(
        ...
        String collectionName = "ticket"; // Colección configurada internamente (nombre de la colección en Firestore)

        // Crear un mapa para simular el cuerpo de la solicitud
        Map<String, Object> data = new HashMap<>();
        data.put("name", name); // Guardar el nombre en el mapa
        data.put("email", responsible); // Guardar el responsable en el mapa
        data.put("age", deadline); // Guardar la fecha de entrega en el mapa
